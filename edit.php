...
$sql="SELECT * FROM florii WHERE ID='{$_GET['id']}'";
$result=mysqli_query($con,$sql);
$record=mysqli_fetch_array($result);
}else{$sql1="UPDATE florii SET nume='{$_POST['nume']}',culoare='{$_POST['culoare']}',marime='{$_POST['marime']}',pret='{$_POST['pret']}' WHERE id='{$_POST['id']}'";
